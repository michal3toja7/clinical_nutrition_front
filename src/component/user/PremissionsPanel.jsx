...
class PremissionsPanel extends Component {
    ...
    selectJosRow = (idJos) => { 
        ...
        this.setState({josSelected: idJos,
    ...
    isJosSelected = (id) => {return (this.state.josSelected === id ? true : false) }
    ...
    selectPremission = (idPremission) => { 
        ...
        this.setState({premissionsForJos: this.state.premissionsForJos,
                      josPanelActive: 'none'})
    }
        ...
        return (
            <div style={flexStyle}>
                ...
                <AssignmentIndRoundedIcon style={iconStyle}></AssignmentIndRoundedIcon>
                    <Typography variant="h4" style={{marginTop: '25px'}} fullwidth align="left"><b>Użytkownik: </b>{this.state.user.imiona} {this.state.user.nazwisko}</Typography>
            ...
            <div style={{width:"48%", marginRight: '2%', pointerEvents: this.state.josPanelActive}}>
                    ...
                    <Typography variant="h5" stle={{alignItems: "center"}}><b>Jednostki Organizacyjne:</b></Typography>
                ...
                <div style={{width:"48%", marginLeft: '2%', pointerEvents: this.state.premissionsPanelActive}}>
                    ...
                    <Typography variant="h5" stle={{alignItems: "center"}}><b>Uprawnienia:</b></Typography>
                        <Table aria-label="custom pagination table">
                            ...
                            <Button variant="contained" onClick={() => this.defaultActive()} style={{width: '48%', marginRight: '2%'}} color="bad">Odrzuć</Button>
                            <Button variant="contained" onClick={this.savePremissions} style={{width: '48%', marginLeft: '2%'}} color="primary">Zapisz</Button>
                    </TableContainer>
                </div>
                </div>
            );
