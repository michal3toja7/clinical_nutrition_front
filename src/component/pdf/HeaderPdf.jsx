...
const HeaderPdf = (props) => (
    <View>
        <View style={styles.header}>
            <Text
                style={styles.header}>{props.order.typ === 'DOJ' ? "Żywiewnie Dojelitowe" : (props.order.typ === 'DOU' ? "Żywiewnie Doustne" : "Zlecenie na worek RTU")}</Text>
        </View>
        ...
        <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
                ...
                <View style={styles.tableCol}>
                    <Text
                        style={styles.tableCell}>{(new Date(props.order.pacjent.dataUrodzenia)).toLocaleDateString()}</Text>
                </View>
                <View style={styles.tableCol}>
            ...
            <View style={styles.tableRow}>
                ...
                <View style={styles.tableCol}>
                    <Text
                        style={styles.tableCell}>{Math.round(100 * (props.order.pomiar.waga / (props.order.pomiar.wzrost * props.order.pomiar.wzrost))) / 100}</Text>
                </View>
            </View>
