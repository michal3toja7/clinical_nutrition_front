            ...
            return (
                <div style={flexStyle}>
                    <div component={Paper} style={{width: "100%", marginTop: '-20px'}}>
                        ...
                        <div style={flexStyle}>
                            ...
                            <div style={{width: '48%', marginRight: '2%'}}>
                                {this.state.newPosActive && (
                                    <div style={posStyle}>
                                        <OrderPositionComponent zamowienieId={this.state.id} typ={this.state.typ}
                                ...
                                {this.state.orderPositions.map((row, index) => (
                                    <div key={row.id} style={posStyle}>
                                        <OrderPositionComponent key={row.id} typ={this.state.typ} pozycja={index + 1}
                                                                updateList={() => this.updateOrderPoss()}
                                                                orderPos={row}/>
                                    </div>
                            ...
                            <div style={{width: '48%', marginLeft: '2%'}}>
                                ...
                                <div style={posStyle}>
                                    <TableIngredientsComponent key={this.state.orderPositions.length}
                                                               getTableIngredients={(tableIngredients) => this.getTableIngredients(tableIngredients)}
                                                               zamowienieId={this.state.id}
                                                               orderPos={this.state.orderPositions} typ={this.state.typ}
                                                               updateList={() => this.updateOrderPoss()}/>
                                </div>
                                }
                            </div>
                            ...
                            <div style={{width: '100%'}}>
                                {this.state.orderPositions.length > 0 &&
                                <div style={posStyle}>
                                    <TableSupplyComponent key={this.state.orderPositions.length}
                                                          zamowienieId={this.state.id} pomiar={this.state.pomiar}
                                                          orderPos={this.state.orderPositions} typ={this.state.typ}
                                                          updateList={() => this.updateOrderPoss()}/>
                                </div>
                                }
                        ...
                        {!this.state.isJosRealizujacy && (
                            <div>
                                <Button style={{width: '23%', margin: '1%'}} disabled={this.state.status !== 'ZAP'}
