...
class ListPreparationBagComponent extends Component {
        ...
        await PreparationBagService.fetchPreparationBags()
            .then(result => {
                if (result.error !== undefined) {
                    ...
                    this.setState({
                        initialPreparationBags: result.data,
    ...
    search = (searchString) => {
        ...
        this.setState({
            preparationBags: this.state.initialPreparationBags
            ...
            return (
                <div>
                                ...
                                {(this.state.rowsPerPage > 0
                                    ...
                                    <TableRow hover key={row.id}>
                                        ...
                                        <TableCell align="right"
                                                   onClick={() => this.editPreparationBag(row.id)}><CreateIcon/></TableCell>
                                    </TableRow>
                                ))}
                    ...
                    <Button style={{float: "right"}} variant="contained" color="primary"
                            onClick={() => this.addPreparationBag()}> Dodaj Preparat</Button>
                </div>
            );
        }
    }
